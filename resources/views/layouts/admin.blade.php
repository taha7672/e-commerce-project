...
<body class="layout-boxed">
        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item theme-brand flex-row text-center">
                ...
                <li class="nav-item theme-text">
                    @if (getSetting('logo_url'))
                        <img src="{{ asset(getSetting('logo_url')) }}" alt="Site Logo"
                            style="max-width: 100px; max-height: 70px;">
                    @else
                        <a href="{{ route('admin.dashboard') }}"
                            class="nav-link">{{ getSetting('brand_name') }}</a>
                    @endif
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
                ...
                <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);" onclick="changeLanguage('en')">
                            <img src="{{ asset('admin-assets/img/1x1/us.svg') }}" class="flag-width" alt="flag">
                            <span class="align-self-center">&nbsp;English</span>
                        </a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);" onclick="changeLanguage('tr')">
                            <img src="{{ asset('admin-assets/img/1x1/tr.svg') }}" class="flag-width" alt="flag">
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        <div class="drodpown-title message">
                            <h6 class="d-flex justify-content-between"><span class="align-self-center">{{__('pages.messages')}}</span>
                                <span class="badge badge-primary">{{ $notificationCount }} <a
                                        href="{{ route('admin.showNotifications') }}" class="text-light"> {{__('pages.unread')}}
                                    </a></span>
                            </h6>
                        </div>
                        <div class="notification-scroll notification_section">
                            @foreach ($notifications as $notification)
                                <div class="dropdown-item">
                                    <div class="media server-log">
                                        <img src="{{ asset('admin-assets/img/dummy.png') }}" class="img-fluid me-2"
                                            alt="avatar">
                                        <div class="media-body">
                                            <div class="data-info">
                                                <h6 class="">{{ $notification->message }}</h6>
                                                <p class="time_ago text-capitalize">{{ $notification->created_at }}
                                                </p>
                                            </div>
                            ...
                            <!-- <div class="dropdown-item">
                                <div class="media ">
                                    <img src="{{ asset('admin-assets/img/profile-15.jpeg') }}" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <!-- <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="{{ asset('admin-assets/img/profile-21.jpeg') }}" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="{{ asset('admin-assets/img/profile-30.png') }}"
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="{{ route('admin.profile') }}">
                                ...
                                </svg> <span>{{__('pages.profile')}}</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
                            <a href="javascript:;"
                                ...
                                </svg> <span>{{__('pages.Log_Out')}}</span>
                            </a>
                        </div>
                    </div>
        ...
        <div id="content" class="main-content">
                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#">{{__('pages.dashboard')}}</a></li>
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">{{__('pages.copyright')}} © <span class="dynamic-year">2024</span> <a target="_blank"
                            href="#">SwapSkill</a>,{{__('pages.all_rights_reserved')}}.</p>
                </div>
            </div>
            <!--  END FOOTER  -->
        </div>
    ...
    <script>
        ...
        fetch(`{{ route('admin.changeLanguage', '') }}/${lang}`, {
            method: 'GET',
            headers: {
