                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="{{__('pages.name')}}" required value="{{$tag->name}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                   ...
                                   {{-- @php if(!empty($tag->image)){ @endphp  <img src="{{asset($tag->image)}}" class="blog-thumbnail" alt="thumbnail">@php }@endphp --}}
                                 @if(!empty($tag->image))
                                    <img src="{{ asset($tag->image) }}" class="blog-thumbnail" alt="thumbnail">
                                @endif
                                </div> 
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="{{__('pages.description')}}" rows="5" required>{{$tag->description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="is_active" id="is_active" class="form-control">
                                    <option value="1" {{$tag->is_active?'selected':''}}>{{__('pages.active')}}</option>
                                    <option value="0" {{!$tag->is_active?'selected':''}}>{{__('pages.inactive')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="text-end">
