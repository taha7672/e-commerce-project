        ...
        <div class="row layout-top-spacing">
                    ...
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                ...
                                <h5 class="">{{__('pages.total_users')}} </h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                ...
                                <p class="w-value">{{ $totalOrders }}</p>
                                <h5 class="">{{__('pages.total_orders')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                ...
                                <p class="w-value">{{ $totalReviews }}</p>
                                <h5 class="">{{__('pages.total_reviews')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                <div class="widget widget-one_hybrid widget-followers">
                    <div class="widget-heading">
                        <div class="w-title">
                            <div class="w-icon dashboard-icon">
                                <i class="fa-solid fa-square-poll-vertical text-md"></i>
                            </div>
                            <div class="">
                                <p class="w-value">${{ $totalSale }}</p>
                                <h5 class="">{{__('pages.total_sales')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget widget-one_hybrid widget-referral">
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                <p class="w-value">${{ $totalRevanue }}</p>
                                <h5 class="">{{__('pages.total_revenue')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget widget-one_hybrid widget-engagement">
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                <p class="w-value">{{ $totalOrderMonthly }}</p>
                                <h5 class="">{{__('pages.monthly_orders')}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="timeline-line">
                                ...
                                @if (!$latestOrders->isEmpty())
                                    @foreach ($latestOrders as $order)
                                        <div class="item-timeline timeline-new">
                                            <div class="t-dot">
                                                <div class="{{ $order->status == 'pending' ? 't-danger' : 't-primary' }}">
                                            ...
                                            <div class="t-content">
                                                <div class="t-uppercontent">
                                                    <h5>${{ $order->total_amount }} - #{{ $order->order_num }}</h5>
                                                </div>
                    ...
                    <div class="widget-content">
                        <div class="vistorsBrowser">
                            <div class="browser-list">
                                ...
                                <div class="w-browser-details">
                                    <div class="w-browser-info">
                                        <h6>{{__('pages.total')}}</h6>
                                        <p class="browser-count">{{ $totalVisitor }}</p>
                                    </div>
                            ...
                            <div class="browser-list">
                                ...
                                <div class="w-browser-details">
                                    <div class="w-browser-info">
                                        <h6>{{__('pages.daily')}}</h6>
                                        <p class="browser-count">{{ $dailyVisitor }}</p>
                                    </div>
                                    {{-- <div class="w-browser-stats">
                                        <div class="progress">
                        ...
                        <div class="meta-info">
                            ...
                            <div class="avatar--group">
                                ...
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('admin-assets/img/profile-8.jpeg') }}" />
                                </div>
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('admin-assets/img/profile-12.jpeg') }}" />
                                </div>
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('admin-assets/img/profile-19.jpeg') }}" />
                                </div>
            ...
            {{-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-card-one">
                    <div class="widget-content">
                        ...
                        <div class="media">
                            <div class="w-img">
                                <img src="{{ asset('admin-assets/img/profile-19.jpeg') }}" alt="avatar">
                            </div>
                    ...
                    @if (!empty($latestOrder))
                        <div class="widget-content">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6>{{__('pages.order_No')}}: #{{ $latestOrder->order_num }}</h6>
                                    <p class="meta-date-time">User: {{ $latestOrder->user->name }}
                                        {{ $latestOrder->user->surname }}</p>
                                </div>
                            </div>

                            <div>
                                <ul>
                                    <li><b>{{__('pages.order_date')}}:</b> {{ date('Y-m-d', strtotime($latestOrder->order_date)) }}</li>
                                    <li><b>{{__('pages.quantity')}}:</b> {{ isset($latestOrder->items) ? count($latestOrder->items) : 1 }}x
                                    </li>
                                    <li><b>{{__('pages.price')}}:</b> ${{ $latestOrder->payment->total_amount }} -
                                        {{ $latestOrder->payment->payment_status }}
                                        <ul>
                                            <li><b>#ID:</b> {{ $latestOrder->payment->transaction_id }} -
                                                {{ $latestOrder->payment->payment_method }}</li>
                                        </ul>
                                    </li>
                                    <li><b>{{__('pages.order_status')}}:</b> {{ $latestOrder->status }}</li>
                                </ul>
                            </div>
                            <div class="card-bottom-section">
                                <a href="{{ route('admin.orders.show', $latestOrder->id) }}" class="btn">{{__('pages.view_details')}}</a>
                            </div>
                        </div>
                    @else
                        <p class="text-center">{{__('pages.no_latest_order_found')}}.!</p>
                    @endif
                </div>
            </div>
            {{-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="account-box">
                            ...
                            <div class="info-box">
                                ...
                                <div class="balance-info">
                                    ...
                                    <p>${{ $latestPayment->total_amount }}</p>
                                    <span class="meta-date-time">{{ $latestPayment->payment_method }}</span>
                                </div>
                            </div>
                            ...
                            <div class="card-bottom-section">
                                <div>
                                    <span class="badge badge-light-success">
                                        {{ $latestPayment->order->user->name }}
                                    </span>
                                </div>
                                <a href="javascript:void(0);" class="">Order:
                                    #{{ $latestPayment->order->order_num }}</a>
                            </div>
                        </div>
                    </div>
                </div>
