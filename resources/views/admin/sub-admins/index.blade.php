        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('pages.sub_admins')}}</h4>
                        </div>
                        <div class="col-4 text-end">
                            <a class="btn btn-success" href="{{route('admin.sub-admins.create')}}">{{__('pages.add_new')}}</a>
                        </div>
                    </div>
                    <table id="categories" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($admins as $index => $admin)
                                <tr>
                                    <td>{{$index+1}}</td>
                                     <td>{{ ucfirst( $admin->name)}} {{$admin->surname}}</td>
                                    <td>{{$admin->email}}</td>
                                    <td>
