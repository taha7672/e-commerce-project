        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('pages.add_new_category')}}</h4>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control file-upload-input" type="file" id="thumbnail" name="image" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="metaDesc" class="form-control" placeholder="Description" rows="5" required></textarea>
                                </div>
                            </div>
