        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('pages.update_category')}}</h4>
                        </div>
                        <div class="col-4 text-end">
                            <a href="{{route('admin.categories.index')}}" class="btn btn-info">{{__('pages.go_back')}}</a>
                        </div>
                    </div>
                    {{-- errors --}}
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Name" required value="{{$category->name}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="Description" rows="5" required>{{$category->description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="is_active" id="is_active" class="form-control">
                                    <option value="1" {{$category->is_active?'selected':''}}>{{__('pages.active')}}</option>
                                    <option value="0" {{!$category->is_active?'selected':''}}>{{__('pages.inactive')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="text-end">
