        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('pages.update_sub_category')}}</h4>
                        </div>
                        ...
                        <div class="col-6">
                                ...
                                <select name="category_id" id="category" class="form-control">
                                    @if(count($category)>0)
                                        @foreach($category as $list)
                                            <option value="{{$list->id}}" {{($subCategory->category_id==$list->id)?'selected':''}}>{{$list->name}}</option>
                                        @endforeach
                                    @else
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="{{__('pages.name')}}" required value="{{$subCategory->name}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    @php
                                        ...
                                        @else
                                            ...
                                            >
                                        @endif
                                    <img src="{{asset($subCategory->image)}}" class="blog-thumbnail" alt="thumbnail">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="{{__('pages.description')}}" rows="5" required>{{$subCategory->description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="is_active" id="is_active" class="form-control">
                                    <option value="1" {{$subCategory->is_active?'selected':''}}>{{__('pages.active')}}</option>
                                    <option value="0" {{!$subCategory->is_active?'selected':''}}>{{__('pages.inactive')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="text-end">
